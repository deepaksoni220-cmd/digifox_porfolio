  ...
  return (
    <main className="Layout_main__h283P" style={{ position: 'relative' }}>
      ...
      <section className="Demo2_HeroSection">
        <div className="Demo2_HeroBg" id="demo2HeroBg" style={{ position: 'absolute', inset: 0, backgroundImage: "url('/assets/_next/static/media/demo2-showroom-stage.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.85, zIndex: 0 }}></div>
        <div className="Demo2_HeroOverlay" style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at center, rgba(11,14,20,0.3) 0%, rgba(11,14,20,0.95) 100%)', zIndex: 1 }}></div>

        <div className="Demo2_Container" style={{ position: 'relative', zIndex: 2, maxWidth: '1380px', margin: '0 auto', width: '100%' }}>
