      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto text-center overflow-hidden">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-white/20 bg-white/[0.05] hover:bg-white/10 text-white px-7 py-4 rounded-full text-sm font-bold transition-all backdrop-blur-md cursor-pointer"
          >
