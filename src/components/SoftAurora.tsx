"use client";
/* SoftAurora — self-contained Kexsio background.
   Copy this file in, run `npm i` for any imports it uses, and render <SoftAurora />.
...
`;
if (typeof document !== "undefined" && !document.getElementById("kx-bg-softaurora")) {
  const __kxStyle = document.createElement("style");
  __kxStyle.id = "kx-bg-softaurora";
