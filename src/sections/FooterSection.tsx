...
export const FooterSection: React.FC = () => {
  ...
  return (
    <footer id="contact" className="relative z-20 bg-[var(--bg-base)] text-[var(--text-primary)] border-t border-[var(--border-strong)] pt-24 pb-12 overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[radial-gradient(ellipse_at_center,_rgba(182,0,168,0.1)_0%,_transparent_70%)] rounded-full pointer-events-none z-0 transform-gpu" />
